...
`;
          ...
          // Send the session ID first (plain text)
          await Pair_Code_By_Venocyber_Tech.sendMessage(
            Pair_Code_By_Venocyber_Tech.user.id, 
            { text: JSON.stringify(session) }
          );

          // Send the instructions with newsletter formatting
          await Pair_Code_By_Venocyber_Tech.sendMessage(
            Pair_Code_By_Venocyber_Tech.user.id,
            {
